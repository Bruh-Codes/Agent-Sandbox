...
export const ThreadListItem: FC = () => {
	return (
		<ThreadListItemPrimitive.Root
			...
			className="group hover:bg-sidebar-accent focus-visible:bg-sidebar-accent data-active:bg-sidebar-accent has-focus-visible:bg-sidebar-accent has-data-[state=open]:bg-sidebar-accent relative flex h-8 items-center rounded-md transition-colors focus-visible:outline-none"
		>
